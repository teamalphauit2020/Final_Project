...
{
?>
	<script type="text/javascript">location.href = 'login.php?lid=6';</script>
<?php
...
//echo $_SESSION['email'];
	...
	$sql = "select distinct pid from orders where email='$email'";
						...
						<div class="col-md-3 product-men"style="height: 500px;">
							<div class="men-pro-item simpleCart_shelfItem" style="height: 450px;">
								...
								<div class="item-info-product ">
									<h4><a href="shop_cart_review.php?pid=<?php echo $row1['pid'] ?>"><?php echo $row1['pname'] ?></a></h4>
									<div class="info-product-price">
									<span class="item_price"><?php echo "Rs.".$row1['price'] ?></span>
										<del><?php echo "Rs.".($row1['price']+500) ?></del><br>
										<?php
										$starNumber = $row1['ratings']; 
										for( $x = 0; $x < 5; $x++ )
   										 {
