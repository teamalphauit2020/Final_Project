			    ...
			    <nav class="navbar navbar-default">
                  ...
                  <?php 
					  ...
					  ?>
						...
						<li class=" menu__item"><a class="menu__link" href="login.php?lid=1">Login</a></li>
						<?php
					  }
					  ?>
					</ul>
						...
						<div class="col-md-3 product-men yes-marg" style="height: 500px;">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product " style="height: 150px;">
									...
									<a href="shop_cart.php?pid=<?php echo $row['pid']; ?>&lid=1" class="item_add single-item hvr-outline-out button2">Buy</a>									
								</div>
							</div>
						</div>
