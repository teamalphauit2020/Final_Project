				  ...
				  <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav menu__list">
					  ...
					  ?>
						...
						<li class=" menu__item"><a class="menu__link" href="login.php?lid=3">Login</a></li>
						<?php
					  }
					  ?>
					</ul>
						...
						<div class="col-md-3 product-men"style="height: 500px;">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product " style="height: 150px;">
									...
									<a href="shop_cart.php?pid=<?php echo $row['pid'] ?>&lid=3" class="item_add single-item hvr-outline-out button2">Buy</a>									
								</div>
							</div>
						</div>
